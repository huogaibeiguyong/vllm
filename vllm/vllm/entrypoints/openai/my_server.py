...
modelpath = {'CodeLlama-7b-hf':'/home/ubuntu/llms/llama/CodeLlama-7b-hf','deepseek-ai/deepseek-coder-6.7b-base':'deepseek-ai/deepseek-coder-6.7b-base'}
...
async def test(request: CompletionRequest):
    print(request)
    return served_model
...
async def show_available_models():
    ...
    model_cards = [
        ModelCard(id=served_model.split('/')[-1], root=served_model.split('/')[-1], permission=[ModelPermission()])
    ]
...
async def create_chat_completion(request: ChatCompletionRequest, raw_request: Request):
    ...
    #在这里更改了模型名称，将模型名称转化为了有着路径的名称
    request.model = modelpath[request.model]
